...
from mcqpy_pdf.compile.latex_helpers import Form, code_block, multi_checkbox, radio_option
from mcqpy_core.question import Question
from mcqpy_pdf.utils.image import check_and_download_tmp
...
def _build_question_image(document: Document, question: Question):
    ...
    if len(question.image) == 1:
        ...
        raw_options = question.image_options.get(0, {}) if question.image_options else {}
        options = {}
